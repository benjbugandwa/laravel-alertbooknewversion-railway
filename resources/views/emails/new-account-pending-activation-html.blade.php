...
<head>
    ...
    <title>Demande de création de compte — AlertBook</title>
    <style>
        ...
        .badge { display: inline-block; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: bold; text-transform: uppercase; background-color: #fff3e0; color: #ef6c00; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Un nouvel utilisateur s'est inscrit sur la plateforme et attend l'activation de son compte pour accéder au système.</p>
            ...
            <div class="info-grid">
                <div class="info-row">
                    ...
                    <div class="info-value"><strong>{{ $newUser->name }}</strong></div>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{{ $newUser->organisation->org_name ?? 'Non spécifiée' }}</div>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <span class="badge">En attente d'activation</span>
                    </div>
                </div>
            </div>

            <p style="margin-top: 30px;">Veuillez vous connecter à la console d'administration pour valider cette demande et attribuer le rôle approprié à cet utilisateur.</p>
            
            <div style="text-align: center;">
                <a href="{{ $manageUrl }}" class="btn">Gérer les utilisateurs</a>
            </div>
        </div>
        <div class="footer">
            Ceci est un message automatique généré par le système AlertBook.<br>
            &copy; {{ date('Y') }} AlertBook — Développé par Research For Development (RFD).
        </div>
    </div>
</body>
</html>
